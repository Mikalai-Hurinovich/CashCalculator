...
//
// export type CashKeyType = 'THOUSANDS' | 'FIVE_HUNDRED' | 'TWO_HUNDRED' | 'ONE_HUNDRED'
//
// export type CashType = {
//     key: CashKeyType,
//     divider: number
// }
// export const cashDividersObj: {
//     [key in CashKeyType]: number
// } = {
//     THOUSANDS: 1000,
//     FIVE_HUNDRED: 500,
//     TWO_HUNDRED: 200,
...
//     allValues: 0
// }
// const setAC = (key: CashKeyType, value: number) => ({type: 'THOUSANDS', key, value})
//
//
// // Initial State
...
//     | sumAllValuesType
//
// const CashReducer = (state: TypedState = initial, action: ActionsType): TypedState => {
//     switch (action.type) {
//         case "SET_THOUSANDS":
